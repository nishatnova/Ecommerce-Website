                            ...
                            <tr>
                                ...
                                <td class="text-center" data-title="Stock">
                                    <div class="input-group w-50 m-auto">
                                        <input type="number" name="data[{{$key}}][qty]" min="1" class="form-control form-control-sm" value="{{$product->qty}}">
                                        <input type="hidden" name="data[{{$key}}][rowId]" class="form-control form-control-sm" value="{{$product->rowId}}">
                                    </div>
                                </td>
                                ...
                                <td class="action" data-title="Remove">
                                    ...
                                    <a href="{{route('cart.delete',['rowId'=> $product->rowId])}}" onclick="return confirm('Are you sure?')" class="btn btn-danger border-0 btn-sm">
                            ...
                            <div class="border p-md-4 p-30 border-radius cart-totals">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="cart_total_label">Tax Amount (10%)</td>
                                            <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">Tk. {{$tax = $sum * 0.10}}</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="cart_total_amount">
                                                ...
                                                <!--
                                                <label><input type="radio" name="shipping_cost" value="60"/>Inside Dhaka (BDT 60)</label>
                                                <label><input type="radio" name="shipping_cost" value="120"/>Outside Dhaka (BDT 120)</label>
                                            -->
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="cart_total_amount">
                                                <strong><span class="font-xl fw-900 text-brand">Tk. {{$sum + $tax + $shippingCost}}</span></strong>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
