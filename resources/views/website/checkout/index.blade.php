                    ...
                    <div class="mb-25">
                        ...
                        <div class="form-group">
                            @if(isset($customer->email))
                                <input type="email" name="email" required="" readonly value="{{$customer->email}}" placeholder="Email Address *"/>
                            @else
                        ...
                        <div class="form-group">
                            @if(isset($customer->mobile))
                                <input type="number" name="mobile" required="" readonly value="{{$customer->mobile}}" placeholder="Mobile Number"/>
                            @else
                    ...
                    <div class="order_review">
                        ...
                        <div class="table-responsive order_table text-center">
                            <table class="table">
                                ...
                                <tr>
                                    <th>Tax Amount (10%)</th>
                                    <td class="product-subtotal" colspan="2">Tk. {{$tax = round ($sum * 0.10)}}</td>
                                </tr>
                                <tr>
                                    <th>Shipping</th>
                                    <td colspan="2"><em>Tk. {{$shippingCost = 100}}</em></td>
                                </tr>
                                <tr>
                                    <th>Total</th>
