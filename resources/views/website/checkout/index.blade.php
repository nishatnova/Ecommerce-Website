                        ...
                        <div class="mb-25">
                            ...
                            <div class="form-group">
                                @if(isset($customer->email))
                                    <input type="email" required="" readonly name="email" value="{{$customer->email}}"  placeholder="Email Address "/>
                                @else
                            ...
                            <div class="form-group">
                                @if(isset($customer->mobile))
                                    <input type="number" required="" readonly name="mobile"  value="{{$customer->mobile}}" placeholder="Mobile Number"/>
                                @else
