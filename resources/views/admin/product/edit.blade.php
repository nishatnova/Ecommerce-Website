                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('product.update', $product->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="shortDescription" name="short_description" placeholder="Product Short Description"> {{$product->short_description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="summernote" class="col-md-3 form-label">Long Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="summernote" name="long_description" placeholder="Product Long Description">{{$product->short_description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input class="form-control" name="regular_price" value="{{$product->regular_price}}" type="number"/>
                                    <input class="form-control" name="selling_price" value="{{$product->selling_price}}" type="number"/>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <button class="btn btn-primary-gradient rounded-0 float-end" type="submit">Update Product</button>
                    </form>
                </div>
            </div>
        </div>
