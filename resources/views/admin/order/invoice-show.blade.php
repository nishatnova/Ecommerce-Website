...
@section('title', 'Show Order Invoice')
                    ...
                    <div class="invoice-box">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr class="item">
                                ...
                                <td align="left">{{$orderDetail->product_price}}</td>
                                <td align="right">{{$orderDetail->product_qty}}</td>
                            ...
                            <tr class="">
                                ...
                                <td></td>
                                <td align="center"></td>
                                <td align="right">Tax: {{ round( ($tax = $sum * 0.10) ) }}</td>
                            </tr>
                            <tr class="">
                                <td></td>
                                <td></td>
                                <td align="center"></td>
                                <td align="right">Shipping Cost: {{$shippingCost=100}}</td>
                            </tr>
                            <tr class="">
                                <td></td>
                                <td></td>
                                <td align="center"></td>
                                <td align="right">Total Payable: {{ $sum+round( ($tax = $sum * 0.10) )+$shippingCost }}</td>
                            </tr>
                        </table>
                    </div>
