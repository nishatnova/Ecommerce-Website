...
@section('body')
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">User Category</a></li>
                        ...
                        <table id="example3" class="table table-bordered text-nowrap border-bottom">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('user.show',$user->id ) }}" class="btn btn-info btn-sm float-start m-1" > <i class="fa fa-eye"></i></a>
                                        <a href="{{route('user.edit', $user->id)}}" class="btn btn-primary btn-sm float-start m-1">
