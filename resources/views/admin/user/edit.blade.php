                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $user->name}}" name="name" id="userName" placeholder="User Name" type="text"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $user->mobile}}" name="mobile" id="mobile" placeholder="User Mobile No." type="number"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            <label for="description" class="col-md-3 form-label">Select Role</label>
                            <div class="col-md-9">
                        ...
                        <button class="btn btn-primary-gradient rounded-0 float-end" type="submit">Update User Info</button>
                    </form>
                </div>
            </div>
        </div>
