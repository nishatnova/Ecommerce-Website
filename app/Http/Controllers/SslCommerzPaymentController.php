...
//
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                return redirect('/complete-order')->with('message','Congratulations! Your order submitted successfully! Please check your mail and wait. We will contact with you soon.');
    ...
    public function fail(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return back('/complete-order')->with('message', 'Transaction is Successful');
        } else {
    ...
    public function cancel(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return back()->with('message', 'Transaction is Canceled');
        } else if ($order_details->order_status == 'Processing' || $order_details->order_status == 'Complete') {
            echo "Transaction is already Successful";
            return back('/complete-order')->with('message', 'Transaction is already Successful');
        } else {
            echo "Transaction is Invalid";
            return back()->with('message', 'Transaction is Invalid');
        }
